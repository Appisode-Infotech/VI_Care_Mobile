...
class ReportsProcessedDataModel {
  ...
  factory ReportsProcessedDataModel.fromJson(Map<String, dynamic> json) => ReportsProcessedDataModel(
    ...
    rrMin: json["RR_Min"]?? 'NA',
    rrMax: json["RR_Max"]?? 'NA',
    ...
    artifactCorrectionBypass: json["Artifact_Correction_Bypass"]?? 'NA',
    afToleranceAv5: json["AF_Tolerance_AV5"]?? 'NA',
    afLoad: json["AF_Load"]?.toString(),
    resamplingBypass: json["Resampling_Bypass"]?? 'NA',
    StringegrationWidthCalculated: json["Stringegration_Width_Calculated"]?? 'NA',
    StringegrationWidthDefault: json["Stringegration_Width_Default"]?? 'NA',
    StringegrationMethod: json["Stringegration_Method"]?? 'NA',
    detrendingBypass: json["Detrending_Bypass"]?? 'NA',
    detrendingMethod: json["Detrending_Method"]?? 'NA',
    detrendingPolynomialDegree: json["Detrending_Polynomial_Degree"]?? 'NA',
    detrendingSmoothingFactor: json["Detrending_Smoothing_Factor"]?? 'NA',
    fftWindowFunction: json["FFT_Window_Function"]?? 'NA',
    dcSwitch: json["DC_Switch"]?? 'NA',
    StringegrationArea: json["Stringegration_Area"]?? 'NA',
    StringegrationNoOverlap: json["Stringegration_No_Overlap"]?? 'NA',
    freqBandsVlf: json["Freq_Bands_VLF"]?? 'NA',
    freqBandsLf: json["Freq_Bands_LF"]?? 'NA',
    freqBandsHf: json["Freq_Bands_HF"]?? 'NA',
    ecgFirmware: json["ECG_Firmware"]?? 'NA',
    ecgRecording: json["ECG_Recording"]?? 'NA',
    ecgDetection: json["ECG_Detection"]?? 'NA',
    hrvAnalysis: json["HRV_Analysis"]?? 'NA',
    statisticalDatabase: json["Statistical_Database"]?? 'NA',
    calculationExportDate: json["Calculation_Export_Date"]?? 'NA',
    calculationExportTime: json["Calculation_Export_Time"]?? 'NA',
    ecgMeasurementDate: json["ECG_Measurement_Date"]?? 'NA',
    ecgMeasurementTime: json["ECG_Measurement_Time"]?? 'NA',
    nComparisonGroup: json["n_Comparison_Group"]?? 'NA',
    nDayOfTime24HRange: json["n_Day_Of_Time_24h_Range"]?? 'NA',
    nAgeRange: json["n_Age_Range"]?? 'NA',
    nAgeMeanSd: json["n_Age_Mean_SD"]?? 'NA',
    ...
    histogram50MsLess251MsGreater239Bpm: json["Histogram50ms_Less251ms_Greater239bpm"]?? 'NA',
    histogram50Ms275Ms218Bpm: json["Histogram50ms_275ms218bpm"]?? 'NA',
    histogram50Ms325Ms185Bpm: json["Histogram50ms_325ms185bpm"]?? 'NA',
    histogram50Ms375Ms160Bpm: json["Histogram50ms_375ms160bpm"]?? 'NA',
    histogram50Ms425Ms141Bpm: json["Histogram50ms_425ms141bpm"]?? 'NA',
    histogram50Ms475Ms126Bpm: json["Histogram50ms_475ms126bpm"]?? 'NA',
    histogram50Ms525Ms114Bpm: json["Histogram50ms_525ms114bpm"]?? 'NA',
    histogram50Ms575Ms104Bpm: json["Histogram50ms_575ms104bpm"]?? 'NA',
    histogram50Ms625Ms96Bpm: json["Histogram50ms_625ms96bpm"]?? 'NA',
    histogram50Ms675Ms89Bpm: json["Histogram50ms_675ms89bpm"]?? 'NA',
    histogram50Ms725Ms83Bpm: json["Histogram50ms_725ms83bpm"]?? 'NA',
    histogram50Ms775Ms77Bpm: json["Histogram50ms_775ms77bpm"]?? 'NA',
    histogram50Ms825Ms73Bpm: json["Histogram50ms_825ms73bpm"]?? 'NA',
    histogram50Ms875Ms67Bpm: json["Histogram50ms_875ms67bpm"]?? 'NA',
    histogram50Ms925Ms65Bpm: json["Histogram50ms_925ms65bpm"]?? 'NA',
    histogram50Ms975Ms62Bpm: json["Histogram50ms_975ms62bpm"]?? 'NA',
    histogram50Ms1025Ms58K5Bpm: json["Histogram50ms_1025ms58k5bpm"]?? 'NA',
    histogram50Ms1075Ms55K8Bpm: json["Histogram50ms_1075ms55k8bpm"]?? 'NA',
    histogram50Ms1125Ms53K3Bpm: json["Histogram50ms_1125ms53k3bpm"]?? 'NA',
    histogram50Ms1175Ms51K1Bpm: json["Histogram50ms_1175ms51k1bpm"]?? 'NA',
    histogram50Ms1225Ms48K9Bpm: json["Histogram50ms_1225ms48k9bpm"]?? 'NA',
    histogram50Ms1275Ms47K1Bpm: json["Histogram50ms_1275ms47k1bpm"]?? 'NA',
    histogram50Ms1325Ms45K3Bpm: json["Histogram50ms_1325ms45k3bpm"]?? 'NA',
    histogram50Ms1375Ms43K6Bpm: json["Histogram50ms_1375ms43k6bpm"]?? 'NA',
    histogram50Ms1425Ms42K1Bpm: json["Histogram50ms_1425ms42k1bpm"]?? 'NA',
    histogram50Ms1475Ms40K6Bpm: json["Histogram50ms_1475ms40k6bpm"]?? 'NA',
    histogram50MsGreater1499MsLess40Bpm: json["Histogram50ms_Greater1499ms_Less40bpm"]?? 'NA',
    breathRateLess9Possible: json["Breath_Rate_Less_9_Possible"]?? 'NA',
    ...
    statuspoStringXClip: json["StatuspoString_X_Clip"]?? 'NA',
    statuspoStringYClip: json["StatuspoString_Y_Clip"]?? 'NA',
    statuspoStringCategory: json["StatuspoString_Category"]?? 'NA',
    statusAfWarning: json["Status_AF_Warning"]?? 'NA',
    statusAfThreshold: json["Status_AF_Threshold"]?? 'NA',
    hrvHaspCredits: json["HRV_HASP_Credits"]?? 'NA',
    tachycardiaPossible: json["Tachycardia_Possible"]?? 'NA',
    ageCorrectionYAxisMs: json["Age_Correction_YAxis_ms"]?? 'NA',
    canBasedOnSampleEntropyPossible: json["CAN_Based_On_Sample_Entropy_possible"]?? 'NA',
    canBasedOnPowerSpectrumPossible: json["CAN_Based_On_Power_Spectrum_possible"]?? 'NA',
    cfsBasedOnPowerSpectrumPossible: json["CFS_Based_On_Power_Spectrum_possible"]?? 'NA',

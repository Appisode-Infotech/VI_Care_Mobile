              ...
              child: prefModel.offlineSavedTests!.isNotEmpty
                  ? ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (prefModel.userData!.id ==
                            prefModel.offlineSavedTests![index].myUserId) {
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(children: [
                                    GestureDetector(
                                      onTap: () {
                                        _showPatientBottomSheet(context, index,
                                            (bool a) {
                                          setState(() {});
                                        });
                                      },
                                                      ...
                                                      .requestDeviceData(
                                                        ...
                                                        "bpmList": prefModel
                                                            .offlineSavedTests![
                                                                index]
                                                            .bpmList,
                                                        "rrIntervalList": prefModel
                                                            .offlineSavedTests![
                                                                index]
                                                            .rrIntervalList,
                                                        "scanDuration": prefModel
                                                            .offlineSavedTests![
                                                                index]
                                                            .scanDuration,
                                                        "scanDurationName": prefModel
                                                            .offlineSavedTests![
                                                                index]
                                                            .scanDurationName,
                                                        "deviceName": prefModel
                                                            .offlineSavedTests![
                                                                index]
                                                            .deviceName,
                                                        "deviceId": prefModel
                                                            .offlineSavedTests![
                                                                index]
                                                            .deviceId,
                                                        "userAndDeviceId": prefModel
                                                            .offlineSavedTests![
                                                                index]
                                                            .userAndDeviceId,
                                                        "selectedDurationId": prefModel
                                                            .offlineSavedTests![
                                                                index]
                                                            .selectedDurationId,
                                                        "enterprisePatientData":

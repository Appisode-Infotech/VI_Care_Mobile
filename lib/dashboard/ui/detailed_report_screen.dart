                      ...
                      builder: (BuildContext context,
                        ...
                        if (snapshot.hasData) {
                          ReportsProcessedDataModel processedData =
                              ReportsProcessedDataModel.fromJson(jsonDecode(
                                  snapshot.data!.result![0].processedData!));
                          List additionalInfo = [
                            {
                              "name": "RMSSDRR",
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          borderRadius: const BorderRadius.all(
                                              Radius.circular(20)),
                                          color: getChipColor(snapshot.data!
                                              .result![0].processingStatus),
                                        ),
                                        child: Center(
                                          child: Text(
                                    ...
                                    child: Stack(
                                      children: [
                                        SfSlider(
                                          ...
                                          value: int.parse(double.parse(
                                                  processedData.bpmMean!)
                                              .toStringAsFixed(0)),
                                          onChanged: (value) {},
                                        ),
                                        const Row(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              (takeTestProvider.reportUserData![
                                                          'weight'] ??
                                                      0)
                                                  .toString(),
                                              style: const TextStyle(

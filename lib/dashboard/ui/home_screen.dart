                                                        ...
                                                        children: [
                                                          CircleAvatar(
                                                            ...
                                                            backgroundColor:
                                                                Colors.grey
                                                                    .shade400,
                                                            child: (reportsSnapshot.data!.result![index].roleId ==
                                                                            2 &&
                                                                        reportsSnapshot.data!.result![index].individualProfile!.profilePicture ==
                                                                            null) ||
                                                                    (reportsSnapshot.data!.result![index].roleId !=
                                                                            2 &&
                                                                        reportsSnapshot.data!.result![index].enterpriseProfile!.profilePicture ==
                                                                            null)
                                                                ? const Icon(
                                                                    Icons
                                                                        .person,

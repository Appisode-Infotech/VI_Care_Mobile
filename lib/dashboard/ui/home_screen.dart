                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              Row(
                                                                children: [
                                                                  CircleAvatar(
                                                                    backgroundImage: reportsSnapshot.data!.result![index].roleId ==
                                                                            2
                                                                        ...
                                                                        : NetworkImage(reportsSnapshot.data!.result![index].enterpriseProfile!.profilePicture !=
                                                                                null
                                                                            ? reportsSnapshot.data!.result![index].enterpriseProfile!.profilePicture!.url!
                                                                            : ''),
                                                                    radius: 30,
                                                                    backgroundColor:
                                                                        Colors
                        ...
                        builder: (BuildContext context,
                          ...
                          if (reportsSnapshot.hasData) {
                            return reportsSnapshot.data!.result!.isNotEmpty
                                ? ListView.builder(
                                    itemCount:
                                        reportsSnapshot.data!.result!.length,
                                    shrinkWrap: true,
                                    physics:
                                        const NeverScrollableScrollPhysics(),
                                    itemBuilder:

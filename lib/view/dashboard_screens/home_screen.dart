          ...
          children: [
                                        ...
                                        children: [
                                          Column(
                                            children: [
                                              ...
                                              Text(
                                                patientReports[index]["repData"]["status"],
                                                style: TextStyle(fontSize: 12, color: patientReports[index]["repData"]["color"]),
                                              )
                                            ],
                                          ),
                                        ],
            ...
            GridView.builder(
              padding: const EdgeInsets.symmetric(horizontal: 10),
                ...
                itemBuilder: (BuildContext context, int index){
                  return (index+1)==patientData.length?Container(
                    height: 100,
                    width: 100,
                    decoration: const BoxDecoration(
                        borderRadius: BorderRadius.all(Radius.circular(12)),
                      ...
                      child:const Center(child: Text("Add New \nPatient",style:TextStyle(color:Colors.black,fontSize:12),))
                  ):Container(
                    ...
                    child: Column(
                      ...
                      // backgroundColor: Colors.grey,
                        backgroundImage: AssetImage( patientData[index]['image']),
                      radius: 20,
                    ),
                    Text(

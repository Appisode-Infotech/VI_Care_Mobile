                        ...
                        child: prefModel.userData!.roleId == 2
                            ? FutureBuilder(
                                ...
                                builder: (BuildContext f1Context,
                                    AsyncSnapshot<IndividualResponseModel>
                                        snapshot) {
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Row(
                                                                            children: [
                                                                              CircleAvatar(
                                                                                backgroundImage: patientSnapshot.data!.result![index].roleId == 2 ? NetworkImage(patientSnapshot.data!.result![index].individualProfile!.profilePicture != null ? patientSnapshot.data!.result![index].individualProfile!.profilePicture!.url! : '') : NetworkImage(patientSnapshot.data!.result![index].enterpriseProfile!.profilePicture != null ? patientSnapshot.data!.result![index].enterpriseProfile!.profilePicture!.url! : ''),
                                                                                radius: 30,
                                                                                backgroundColor: Colors.grey.shade400,
                                                                                child: (patientSnapshot.data!.result![index].roleId == 2 && patientSnapshot.data!.result![index].individualProfile!.profilePicture == null) || (patientSnapshot.data!.result![index].roleId != 2 && patientSnapshot.data!.result![index].enterpriseProfile!.profilePicture == null) ? const Icon(Icons.person, size: 30, color: Colors.white) : null,
                                                                              ),
                                                                              const SizedBox(
                                                                                width: 20,
                                                                              ),
                            ...
                            : FutureBuilder(
                                ...
                                builder: (BuildContext f1Context,
                                    AsyncSnapshot<EnterpriseResponseModel>
                                        snapshot) {
                                  if (snapshot.connectionState ==
                                      ConnectionState.waiting) {
                                    return Center(

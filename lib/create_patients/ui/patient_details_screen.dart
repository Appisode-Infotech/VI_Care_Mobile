                                ...
                                Container(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      FutureBuilder(
                                        future: patientProvider.getCounts(
                                                              ...
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  Row(
                                                                    children: [
                                                                      CircleAvatar(
                                                                        backgroundImage: patientSnapshot.data!.result![index].roleId ==
                                                                                2
                                                                            ? NetworkImage(patientSnapshot.data!.result![index].individualProfile!.profilePicture != null
                                                                                ? patientSnapshot.data!.result![index].individualProfile!.profilePicture!.url!
                                                                                : '')
                                                                      ...
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          const SizedBox(
                                                                              height: 5),
                                                                          Text(
                                                                              "${patientSnapshot.data!.result![index].durationName!} Test"),
                                                                          // Text(
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                          ...
                                                                          decoration:
                                                                            ...
                                                                            color:
                                                                                getChipColor(patientSnapshot.data!.result![index].processingStatus),
                                                                          ),
                                                                          child:
                                                                              Center(
                                                                            child:

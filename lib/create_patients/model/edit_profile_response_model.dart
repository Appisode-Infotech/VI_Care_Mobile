...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
        ...
        profilePicture: json["profilePicture"] == null
            ? null
            : ResultProfilePicture.fromJson(json["profilePicture"]),
        enterpriseId: json["enterpriseId"],
        enterprise: json["enterprise"] == null
            ? null
            : ResultEnterprise.fromJson(json["enterprise"]),
        enterpriseUserId: json["enterpriseUserId"],
        enterpriseUser: json["enterpriseUser"] == null
            ? null
            : ResultEnterpriseUser.fromJson(json["enterpriseUser"]),
...
class ResultEnterprise {
  ...
  factory ResultEnterprise.fromJson(Map<String, dynamic> json) =>
      ResultEnterprise(
        id: json["id"],
        uniqueGuid: json["uniqueGuid"],
        name: messageValues.map[json["name"]]!,
        ...
        enterpriseUser: json["enterpriseUser"] == null
            ? []
            : List<ResultEnterpriseUser>.from(json["enterpriseUser"]!
                .map((x) => ResultEnterpriseUser.fromJson(x))),
      );
...
class ResultEnterpriseUser {
  ...
  factory ResultEnterpriseUser.fromJson(Map<String, dynamic> json) =>
      ResultEnterpriseUser(
        id: json["id"],
        uniqueGuid: json["uniqueGuid"],
        name: messageValues.map[json["name"]]!,
...
class ResultProfilePicture {
  ...
  factory ResultProfilePicture.fromJson(Map<String, dynamic> json) =>
      ResultProfilePicture(
        id: json["id"],
        uniqueGuid: json["uniqueGuid"],
        name: messageValues.map[json["name"]]!,
        ...
        device: json["device"] == null
            ? null
            : PurpleDevice.fromJson(json["device"]),
      );
...
class UserProfilePicture {
  ...
  factory UserProfilePicture.fromJson(Map<String, dynamic> json) =>
      UserProfilePicture(
        ...
        device: json["device"] == null
            ? null
            : FluffyDevice.fromJson(json["device"]),
      );

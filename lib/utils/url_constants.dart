class UrlConstants {
  ...
  static const String getStateMaster =
      "${apiBaseUrl}State/GetStatesByCountryId";
  static const String requestDeviceData = "${apiBaseUrl}RequestDeviceData";
  static const String getRequestBySearchFilter =
      "${apiBaseUrl}RequestDeviceData/GetRequestBySearchFilter";
  static const String mResponseReport =
      "${apiBaseUrl}MResponseReport/GetReportsBySearchFilter";
  static const String mDashboard =
      "${apiBaseUrl}MDashboard/GetProfileDashboardCounts";
  static const String getResponseDocumentsByUserId =
      "${apiBaseUrl}ResponseDeviceDocument/GetResponseDocumentsByUserId";
  static const String getAllReportsByUserId =
      "${apiBaseUrl}ResponseReport/GetAllReportsByUserId";
  static const String getSummaryReport =

mixin AppLocale {
  ...
  static const Map<String, dynamic> EN = {
    ...
    conCent: "Consent",
    confirmRecordShare:
        "By confirming, you agree to share the recorded scan data with",
    ...
    lfPower: "LF Power ms",
    lfPowerDescription:
    '''Low Frequency indicates the stress state of the individual.\nLF power in HRV analysis is a measure of the balance between sympathetic and parasympathetic activity in the autonomic nervous system. A higher LF power value may indicate increased sympathetic activity, which is associated with the body's "fight or flight" response to stress. Conversely, a lower LF power value may indicate increased parasympathetic activity, which is associated with the body's "rest and digest" response and can be a positive indicator of heart health and overall fitness.\nNormal Range: 100-500 ms² (higher values are not good).''',
    hfPower: "HF Power ms",
    hfPowerDescription:
    ...
    strongPassword:
        'Password should min be 8 characters, should contain 1 Capital, 1 number, 1special character',
    ...
    disconnectMessage:
        'Disconnecting in middle of the test will result in loss of recorded data for this test',
    ...
    device: "Device",
    devicePoweredOn:
        "* Please ensure that the device is powered on, worn, and ready to connect",
    deviceTypeNotSupported:
        "Selected device type is not supported at the moment",
    deviceNotInTheRange:
        "Device not in range. Please ensure that the device is powered on, worn, and ready to connect",
    couldNotConnect: "Could not connect",
    bluetoothOffTurn:
        "Looks like bluetooth is off. Please turn on to continue.",
    ...
    testSuccessSendHRV:
        "Test successfully sent to hrv server.You can check the reports in some time",
    thisWeek: "All Time",
    thisMonth: "This Week",
    thisYear: "This Month",
    never: "Never",
  ...
  static const Map<String, dynamic> KN = {
    ...
    reports: 'ವರದಿಗಳು',
    disconnectMessage:
        'ಪರೀಕ್ಷೆಯ ನಡುವೆ ಸಂಪರ್ಕ ಮುಂದುವರಿಸುವುದರ ಮಧ್ಯದಲ್ಲಿ ನಡೆಯುವುದು ಈ ಪರೀಕ್ಷೆಗೆ ನೋಟಗಳ ನಷ್ಟವನ್ನು ತರುತ್ತದೆ',
    ...
    years: "ವರ್ಷಗಳು",
    deviceDisconnectedRange:
        "ಸಾಧನ ಅಪ್ರತ್ಯಕ್ಷವಾಗಿ ಸಂಪರ್ಕ ಮರೆತಿದೆ. ಖಾತರಿಯಿಟ್ಟಿದೆ ಎಂದು ಖಚಿತವಿದ್ದಿರಿ.",
    ...
    testCompletedSuccessful:
        "ಪರೀಕ್ಷೆ ಯಶಸ್ವಿಯಾಗಿ ಪೂರ್ಣಗೊಂಡಿದೆ. ಈಗ ನೀವು ಏನು ಮಾಡಬಯಸುತ್ತೀರಿ?",
    ...
    home: 'ಮುಖಪುಟ',
    deviceNotAdded:
        "ನೀವು ಇನ್ನೂ ಯಾವುದೇ ಉಪಕರಣಗಳನ್ನು ಸೇರಿಸಿಲ್ಲ. ಮುಂದುವರಿಸಲು ದಯವಿಟ್ಟು ಉಪಕರಣವನ್ನು ಸೇರಿಸಿ.",
    ...
    device: "ಉಪಕರಣ",
    devicePoweredOn:
        "* ದಯವಿಟ್ಟು ಉಪಕರಣವು ಸ್ವಿಚ್ ಆನ್ ಮಾಡಲಾಗಿದೆ, ಧರಿಸಲು ಸಿದ್ಧವಾಗಿದೆ ಮತ್ತು ಸಂಪರ್ಕಿಸಲು ಸಿದ್ಧವಾಗಿದೆ",
    deviceTypeNotSupported: "ಈಗ ಆಯ್ಕೆಯಾದ ಉಪಕರಣ ಪ್ರಕಾರವನ್ನು ಬೆಂಬಲಿಸಲಾಗಿಲ್ಲ",
    deviceNotInTheRange:
        "ಉಪಕರಣ ಶ್ರೇಣಿಯಲ್ಲಿಲ್ಲ. ದಯವಿಟ್ಟು ಉಪಕರಣವು ಸ್ವಿಚ್ ಆನ್ ಮಾಡಲಾಗಿದೆ, ಧರಿಸಲು ಸಿದ್ಧವಾಗಿದೆ ಮತ್ತು ಸಂಪರ್ಕಿಸಲು ಸಿದ್ಧವಾಗಿದೆ",
    ...
    testSuccessSendHRV:
        "ಟೆಸ್ಟ್ ಯಶಸ್ವಿಯಾಗಿ HRV ಗಣಕಕ್ಕೆ ಕಳುಹಿಸಲಾಗಿದೆ. ನೀವು ಸ್ಥಳೀಯ ಕಾಲದಲ್ಲಿ ವರದಿಗಳನ್ನು ಪರಿಶೀಲಿಸಬಹುದು",
    thisWeek: "ಎಲ್ಲಾ ಸಮಯ",
    thisMonth: "ಈ ವಾರ",
    thisYear: "ಈ ತಿಂಗಳು",
    never: "ಎಂದೂ ಅಲ್ಲ",
    notAddedDevice:
        "ನೀವು ಇನ್ನು ಯಾವ ಯಂತ್ರಗಳನ್ನು ಸೇರಿಸಿದ್ದೀರಿ ಅಲ್ಲ. ಮುಂದುವರಿಸಲು ಯಂತ್ರವನ್ನು ಸೇರಿಸಿ.",
    ...
    reportNotReady:
        "ಅರಿವಿಗೆ ಬರುವವರೆಗೆ ವರದಿ ಸಿದ್ಧವಾಗಿಲ್ಲ. ದಯವಿಟ್ಟು ಸ್ವಲ್ಪ ಸಮಯದ ನಂತರ ಪರಿಶೀಲಿಸಿ",
    ...
    height: "ಎತ್ತರ (ಮೀಟರ್)",
    denyLocation:
        "ಮುಂದೆ ಸಾಗಲು ಸ್ಥಳ ಅನುಮತಿ ಅಗತ್ಯವಿದೆ. ದಯವಿಟ್ಟು ಸಕ್ರಿಯಗೊಳಿಸಿ ಮತ್ತು ಮರುಪ್ರಯತ್ನಿಸಿ",
    agree: "ಒಪ್ಪಿಗೆ",
    conCent: "ಒಪ್ಪಿಗೆ",
    confirmRecordShare:
        "ದೃಢೀಕರಿಸುವ ಮೂಲಕ, ನೀವು ದಾಖಲಿತ ಸ್ಕಾನ್ ಡೇಟಾವನ್ನು ಹಂಚಿಕೊಳ್ಳಲು ಒಪ್ಪುತ್ತೀರಿ",
    noInternet: "ಇಂಟರ್ನೆಟ್ ಇಲ್ಲ",
    checkInternet:
        "ದಯವಿಟ್ಟು ನಿಮ್ಮ ಇಂಟರ್ನೆಟ್ ಸಂಪರ್ಕವನ್ನು ಪರಿಶೀಲಿಸಿ ಮತ್ತು ಮರುಪ್ರಯತ್ನಿಸಿ.",
    ...
    reportsNotReady:
        "ವರದಿ ಇನ್ನೂ ಸಿದ್ಧವಾಗಿಲ್ಲ. ದಯವಿಟ್ಟು ಕೆಲ ಕಾಲದ ನಂತರ ಪರಿಶೀಲಿಸಿ",
    reportsFailedGenerate:
        "ವರದಿ ರಚಿಸಲು ವಿಫಲವಾಗಿದೆ. ದಯವಿಟ್ಟು ಮತ್ತೆ ಪರೀಕ್ಷೆ ಮಾಡಿರಿ",
    bpmMean: "BPM ಸರಾಸರಿ",
    ...
    lfPower: "LF ಶಕ್ತಿ ms",
    lfPowerDescription:
        '''ಕಡಿಮೆ ಆವರ್ತನವು ವ್ಯಕ್ತಿಯ ಒತ್ತಡದ ಸ್ಥಿತಿಯನ್ನು ಸೂಚಿಸುತ್ತದೆ.
    ...
    hfPower: "HF ಶಕ್ತಿ ms",
    hfPowerDescription:
        '''ಹೈ ಆವರ್ತನವು ವ್ಯಕ್ತಿಯ ವಿಶ್ರಾಂತಿ ಅಥವಾ ಪುನರನ್ವೇಷಣ ಸಾಮರ್ಥ್ಯವನ್ನು ಸೂಚಿಸುತ್ತದೆ.
    ...
    sdrr: "SDRR",
    sdrrDescription:
        '''SDRR ಒಟ್ಟು ಹೃದಯದ ಪ್ರಮಾಣವೈವಿಧ್ಯತೆಯನ್ನು (ಸಮಯ ಆಧಾರದ) ಅಳೆಯುತ್ತದೆ. ಹೆಚ್ಚಿನ ಮೌಲ್ಯಗಳು ಉತ್ತಮ ಹೃದಯದ ಆರೋಗ್ಯ ಮತ್ತು ಶಾರೀರಿಕ ತೊಂದರೆಗಳ ಸಂಕೇತವಾಗಿವೆ. ಕಡಿಮೆ ಮೌಲ್ಯಗಳು ಒತ್ತಡ ಅಥವಾ ದಣಿವಿನ ಸಂಕೇತವಾಗಬಹುದು. ಸಾಮಾನ್ಯ ಶ್ರೇಣಿ: 30-200 ms.''',
    rmssdrr: "RMSSDRR",
    rmssdrrDescription: '''
  ...
  static const Map<String, dynamic> HI = {
    ...
    disconnectMessage:
        'टेस्ट के बीच में विच्छेद करने से इस टेस्ट के लिए रिकॉर्ड किए गए डेटा का नुकसान होगा',
    ...
    years: "वर्ष",
    deviceDisconnectedRange:
        "डिवाइस अप्रत्याशित रूप से डिस्कनेक्ट हो गया। सुनिश्चित करें कि डिवाइस रेंज में है।",
    ...
    testCompletedSuccessful:
        "परीक्षण सफलतापूर्वक पूरा हुआ। अब आप क्या करना चाहेंगे?",
    ...
    home: 'होम',
    deviceNotAdded:
        "आपने अभी तक कोई डिवाइस नहीं जोड़ा है। कृपया जारी रखने के लिए डिवाइस जोड़ें।",
    ...
    device: "डिवाइस",
    devicePoweredOn:
        "* कृपया सुनिश्चित करें कि डिवाइस चालू है, पहना जा रहा है, और कनेक्ट करने के लिए तैयार है",
    deviceTypeNotSupported:
        "वर्तमान में चयनित डिवाइस प्रकार का समर्थन नहीं किया गया है",
    deviceNotInTheRange:
        "डिवाइस रेंज में नहीं है। कृपया सुनिश्चित करें कि डिवाइस चालू है, पहना जा रहा है, और कनेक्ट करने के लिए तैयार है",
    couldNotConnect: "कनेक्ट नहीं किया जा सका",
    bluetoothOffTurn:
        "लगता है ब्लूटूथ बंद है। कृपया जारी रखने के लिए ब्लूटूथ चालू करें।",
    ...
    testSuccessSendHRV:
        "टेस्ट सफलतापूर्वक hrv सर्वर को भेजा गया। आप कुछ समय में रिपोर्ट देख सकते हैं",
    thisWeek: "सभी समय",
    thisMonth: "इस सप्ताह",
    thisYear: "इस महीने",
    never: "कभी नहीं",
    ...
    reportsFailed:
        "लगता है रिपोर्ट तैयार करने में विफल रही। कृपया पुनः परीक्षण लें",
    ...
    height: "ऊंचाई (मीटर)",
    denyLocation:
        "आगे बढ़ने के लिए स्थान अनुमति की आवश्यकता है। कृपया सक्षम करें और पुनः प्रयास करें",
    agree: "सहमत",
    conCent: "सहमति",
    confirmRecordShare:
        "पुष्टि करके, आप रिकॉर्ड किए गए स्कैन डेटा को साझा करने के लिए सहमत हैं",
    ...
    reportsNotReady:
        "रिपोर्ट अभी तैयार नहीं है। कृपया कुछ समय बाद पुनः जाँच करें",
    reportsFailedGenerate:
        "लगता है कि रिपोर्ट बनाने में विफल रही है। कृपया फिर से परीक्षा दें",
    bpmMean: "BPM औसत",
    ...
    hfPower: "HF शक्ति ms",
    hfPowerDescription:
        '''उच्च आवृत्ति व्यक्ति की विश्राम या पुनर्योजी क्षमता को दर्शाती है।
    ...
    sdrr: "SDRR",
    sdrrDescription:
        '''SDRR कुल हृदय दर विविधता (समय-आधारित) का माप करता है। उच्च मान बेहतर हृदय स्वास्थ्य और फिटनेस का संकेत करते हैं। निम्न मान तनाव या थकान का संकेत हो सकते हैं। सामान्य रेंज: 30-200 ms।''',
    rmssdrr: "RMSSDRR",
    rmssdrrDescription: '''
  ...
  static const Map<String, dynamic> de = {
    ...
    years: "Jahre",
    deviceDisconnectedRange:
        "Gerät unerwartet getrennt. Stellen Sie sicher, dass das Gerät in Reichweite ist.",
    ...
    somethingWentWrong:
        "Etwas ist schief gelaufen, Daten konnten nicht generiert werden",
    testCompletedSuccessful:
        "Test erfolgreich abgeschlossen. Was möchten Sie jetzt tun?",
    ...
    home: 'Zuhause',
    deviceNotAdded:
        "Sie haben noch keine Geräte hinzugefügt. Bitte fügen Sie das Gerät hinzu, um fortzufahren.",
    chooseImageSource: "Bildquelle auswählen",
    cropImage: 'Bild zuschneiden',
    testNext:
        "Test erfolgreich abgeschlossen, was möchten Sie als nächstes tun?",
    ...
    device: "Gerät",
    devicePoweredOn:
        "* Stellen Sie sicher, dass das Gerät eingeschaltet, getragen und bereit zur Verbindung ist",
    deviceTypeNotSupported:
        "Der ausgewählte Gerätetyp wird derzeit nicht unterstützt",
    deviceNotInTheRange:
        "Gerät nicht in Reichweite. Stellen Sie sicher, dass das Gerät eingeschaltet, getragen und bereit zur Verbindung ist",
    couldNotConnect: "Konnte keine Verbindung herstellen",
    bluetoothOffTurn:
        "Bluetooth ist anscheinend ausgeschaltet. Bitte einschalten, um fortzufahren.",
    ...
    testSuccessSendHRV:
        "Test erfolgreich an hrv Server gesendet. Sie können die Berichte in Kürze überprüfen",
    thisWeek: "Alle Zeit",
    ...
    reportNotReady:
        "Der Bericht ist noch nicht bereit. Bitte überprüfen Sie später erneut",
    reportsFailed:
        "Es scheint, dass der Bericht nicht erstellt werden konnte. Bitte machen Sie einen erneuten Test",
    ...
    height: "Höhe (Meter)",
    denyLocation:
        "Standortberechtigung ist erforderlich, um fortzufahren. Bitte aktivieren und erneut versuchen",
    agree: "Zustimmen",
    conCent: "Zustimmung",
    confirmRecordShare:
        "Durch Bestätigen stimmen Sie zu, die aufgezeichneten Scandaten zu teilen",
    ...
    discard: 'Verwerfen',
    success: "Erfolg",
    noInternetRetryFailed:
        "Keine Internetverbindung! Erneuter Versuch fehlgeschlagen",
    retry: "Erneut versuchen",
    forImprovements: "zur Verbesserung",
    reportsNotReady:
        "Bericht ist noch nicht fertig. Bitte in einiger Zeit wieder nachsehen",
    reportsFailedGenerate:
        "Es sieht so aus, als ob der Bericht nicht erstellt werden konnte. Bitte testen Sie es erneut",
    ...
    lfPowerDescription:
        '''Niedrige Frequenz zeigt den Stresszustand des Einzelnen an.
    ...
    hfPowerDescription:
        '''Hohe Frequenz zeigt den Entspannungs- oder Regenerationszustand des Einzelnen an.
    ...
    sdrr: "SDRR",
    sdrrDescription:
        '''SDRR misst die Gesamt-Herzfrequenzvariabilität (zeitbasiert). Höhere Werte deuten auf eine bessere Herzgesundheit und Fitness hin. Niedrigere Werte können auf Stress oder Müdigkeit hinweisen. Normalbereich: 30-200 ms.''',
    rmssdrr: "RMSSDRR",
    rmssdrrDescription: '''
  ...
  static const Map<String, dynamic> TE = {
    ...
    high: "అధిక",
    disconnectMessage:
        'పరీక్ష యొక్క మధ్యలో ఆదేశంలో వ్యవహారాన్ని వియుక్తి చేయడం ఈ పరీక్షకు రికార్డు చేసిన డేటా నుంచి నష్టమవుతుంది',
    ...
    years: "సంవత్సరాలు",
    deviceDisconnectedRange:
        "పరికరం అదుపులో ఆంతరికంగా ఇలాగా మిస్తుంది. ఖచ్చితంగా పరికరం శ్రేణిలో ఉండవచ్చు.",
    ...
    testCompletedSuccessful:
        "పరీక్ష విజయవంతంగా పూర్తయింది. ఇప్పుడు మీరు ఏమి చేయాలి?",
    ...
    home: 'హోమ్',
    deviceNotAdded:
        "మీరు ఇంకా ఎటువంటి పరికరాలను జోడించలేదు. కొనసాగడానికి దయచేసి పరికరం జోడించండి.",
    ...
    device: "పరికరం",
    devicePoweredOn:
        "* దయచేసి ఖాతా ఉండకుండా, ధరించబడిన మరియు కనెక్ట్ చేయడానికి సిద్ధంగా ఉండవచ్చు",
    deviceTypeNotSupported: "ఎంచుకున్న పరికరం రకం ప్రస్తుతం మద్దతు చేయబడదు",
    deviceNotInTheRange:
        "పరికరం శ్రేణిలో లేదు. దయచేసి పరికరం ఖాతా ఉండకుండా, ధరించబడిన మరియు కనెక్ట్ చేయడానికి సిద్ధంగా ఉండవచ్చు",
    couldNotConnect: "కనెక్ట్ చేయలేకపోయింది",
    bluetoothOffTurn:
        "బ్లూటూత్ ఆఫ్ అయిపోయింది. కొనసాగడానికి దయచేసి ఆన్ చేయండి.",
    ...
    testSuccessSendHRV:
        "టెస్ట్ యశస్వితంగా hrv సర్వర్‌కు పంపబడింది. కొనసాగించుకోవడానికి మీరు కొనసాగాల్సిన సమయంలో నివేదికలను తనిఖీ చేయవచ్చు",
    thisWeek: "అన్నీ సమయం",
    thisMonth: "ఈ వారం",
    thisYear: "ఈ నెల",
    never: "ఎప్పుడూ కాదు",
    ...
    results: "ఫలితాలు",
    notAddedDevice:
        "మీరు ఇంకా ఎటువంటి పరికరాన్ని జోడించలేదు. కొన్ని పరికరాన్ని జోడించండి కొనసాగించడానికి.",
    ...
    reportNotReady:
        "నిర్వచిత సమయంలో అరచేత సమాచారం లేదు. దయచేసి సమయం తర్వాత తిరిగి తనిఖీ చేయండి",
    ...
    denyLocation:
        "కొనసాగేందుకు స్థానం అనుమతి అవసరం. దయచేసి సక్రియం చేసి మళ్లీ ప్రయత్నించండి",
    agree: "అంగీకరించు",
    conCent: "అంగీకారం",
    confirmRecordShare:
        "నిర్ధారించడం ద్వారా, మీరు రికార్డ్ చేసిన స్కాన్ డేటాను పంచుకోవడానికి అంగీకరిస్తారు",
    ...
    reportsNotReady:
        "నివేదిక ఇంకా సిద్ధం కాలేదు. దయచేసి కొంతసేపటి తరువాత తిరిగి చూసుకోండి",
    reportsFailedGenerate:
        "నివేదిక రూపొందించడంలో విఫలమైనట్లు కనిపిస్తోంది. దయచేసి మళ్లీ పరీక్షించండి",
    bpmMean: "BPM సగటు",
    ...
    lfPower: "LF శక్తి ms",
    lfPowerDescription:
        '''తక్కువ ఫ్రీక్వెన్సీ వ్యక్తి యొక్క ఒత్తిడి స్థితిని సూచిస్తుంది.
    ...
    hfPower: "HF శక్తి ms",
    hfPowerDescription:
        '''అధిక ఫ్రీక్వెన్సీ వ్యక్తి యొక్క విశ్రాంతి లేదా పునరుద్ధరణ సామర్థ్యాన్ని సూచిస్తుంది.
    ...
    sdrr: "SDRR",
    sdrrDescription:
        '''SDRR మొత్తం హృదయ స్పందన వైవిధ్యాన్ని (సమయం ఆధారంగా) కొలత. ఎక్కువ విలువలు మంచి హృదయ ఆరోగ్యం మరియు ఫిట్నెస్‌ను సూచిస్తాయి. తక్కువ విలువలు ఒత్తిడి లేదా అలసటను సూచించవచ్చు. సాధారణ పరిధి: 30-200 ms.''',
    rmssdrr: "RMSSDRR",
    rmssdrrDescription: '''
  ...
  static const Map<String, dynamic> TA = {
    ...
    disconnectMessage:
        'சேர்க்கையின் மத்தியில் தொலைபேசி சேர்க்கை இந்த சோதனைக்கு சேமித்த தரவுகளின் இழப்பை தரும்',
    ...
    years: "ஆண்டு",
    deviceDisconnectedRange:
        "சாதனம் எதிர்காலத்தில் இணைக்கப்படவில்லை. உறுதிப்படுத்துகிறது சாதனம் பரப்பப்பட்டிருக்கின்றது.",
    ...
    testCompletedSuccessful:
        "சோதனை வெற்றிகரமாக முடிந்தது. இப்போது நீங்கள் என்ன செய்ய விரும்புகிறீர்கள்?",
    ...
    home: 'முகப்பு',
    deviceNotAdded:
        "நீங்கள் இன்னும் எந்த சாதனங்களையும் சேர்க்கவில்லை. தொடர்ந்து சேர்க்க சாதனம் சேர்க்கவும்.",
    chooseImageSource: "படத்தின் மூலத்தைத் தேர்வுசெய்க",
    cropImage: 'படத்தை கட்டுப்படுத்து',
    testNext:
        "சோதனை வெற்றிகரமாக முடிந்தது, நீங்கள் என்ன செய்ய விரும்புகிறீர்கள்?",
    ...
    device: "சாதனம்",
    devicePoweredOn:
        "* உங்கள் சாதனம் இயக்கப்பட்டு, அணுகுமுறைப் பொருந்தும் மற்றும் இணைக்க உட்படுகின்றது என்பதை உறுதிசெய்க",
    deviceTypeNotSupported:
        "தற்காலிகமாக தேர்ந்தெடுக்கப்பட்ட சாதன வகை ஆதரிக்கப்படவில்லை",
    deviceNotInTheRange:
        "சாதனம் அடித்தளத்தில் இல்லை. தயவுசெய்து உங்கள் சாதனம் இயக்கப்பட்டு, அணுகுமுறையில் இருக்கும் மற்றும் இணைக்க உட்படுகின்றது என்பதை உறுதிசெய்க",
    couldNotConnect: "இணைக்க முடியவில்லை",
    bluetoothOffTurn:
        "பொதுவாக புளூடூத் ஆஃப் ஆகவில்லை. தொடர்ந்து செயல்படுத்த தயவுசெய்து இடைநிலை அமைத்துக் கொள்ளவும்.",
    ...
    testSuccessSendHRV:
        "சோதனை வெற்றிகரமாக hrv சேவையில் அனுப்பப்பட்டுள்ளது. நீங்கள் கொழுப்பு நேரத்தில் அறிக்கைகளை சரிபார்க்கலாம்",
    ...
    results: "முடிவுகள்",
    notAddedDevice:
        "நீங்கள் இன்னும் எந்த சாதனங்களையும் சேர்க்கவில்லை. தொடர்ந்து செல்கிறது சாதனத்தைச் சேர்க்கவும்.",
    ...
    reportNotReady:
        "அறிக்கை தயாராக இல்லை. தயவு செய்து சிறிய நேரம் பின்னூட்டவும் சரிபார்க்கவும்",
    reportsFailed:
        "அறிக்கை உருவாக்குதல் தோல்வியடைந்துள்ளது போல தெரியும். மீண்டும் சேர்க்கையைச் செய்யுங்கள்",
    deviceKey: "சாதன விசை",
    registration: 'பதிவு',
    ...
    denyLocation:
        "தொடர எங்கு அனுமதி தேவை. தயவுசெய்து இயக்கி மீண்டும் முயற்சிக்கவும்",
    agree: "ஒப்புதல்",
    conCent: "ஒப்புதல்",
    confirmRecordShare:
        "உறுதிப்படுத்துவதன் மூலம், நீங்கள் பதிவுசெய்த ஸ்கேன் தரவுகளை பகிர ஒப்புக்கொள்கிறீர்கள்",
    noInternet: "இணையம் இல்லை",
    checkInternet:
        "தயவுசெய்து உங்கள் இணைய இணைப்பை சரிபார்த்து மீண்டும் முயற்சிக்கவும்.",
    reportProcessing:
        'அறிக்கை இன்னும் செயலாக்கப்படுகின்றது. தயவுசெய்து காத்திருக்கவும்',
    ...
    success: "வெற்றி",
    noInternetRetryFailed:
        "இணைய இணைப்பு இல்லை! மீண்டும் முயற்சி தோல்வியடைந்தது",
    retry: "மீண்டும்",
    forImprovements: "மேம்பாடுகளுக்காக",
    reportsNotReady:
        "அறிக்கை இன்னும் தயாராகவில்லை. சிறிது நேரம் கழித்து மீண்டும் சரிபார்க்கவும்",
    reportsFailedGenerate:
        "அறிக்கையை உருவாக்க முடியாதது போல் தோன்றுகிறது. தயவுசெய்து மீண்டும் ஒரு தேர்வு எடுக்கவும்",
    bpmMean: "BPM சராசரி",
    ...
    lfPowerDescription:
        '''குறைந்த மின்சக்தி தனிநபரின் அழுத்த நிலையை குறிக்கிறது.
    ...
    hfPowerDescription:
        '''உயர் மின்சக்தி தனிநபரின் ஓய்வு அல்லது மீட்பு திறனை குறிக்கிறது.
    ...
    sdrr: "SDRR",
    sdrrDescription:
        '''SDRR மொத்த இதய முறைமையை (நேர அடிப்படையில்) அளவிடும் ஒரு முறை. அதிக மதிப்புகள் நல்ல இதய ஆரோக்கியம் மற்றும் உடல் நிலையை குறிக்கின்றன. குறைந்த மதிப்புகள் அழுத்தம் அல்லது களைப்பை குறிக்கலாம். சாதாரண வரம்பு: 30-200 ms.''',
    rmssdrr: "RMSSDRR",
    rmssdrrDescription: '''
  ...
  static const Map<String, dynamic> ML = {
    ...
    street: "സ്ട്രീറ്റ്",
    disconnectMessage:
        'ടെസ്റ്റിന്റെ ഇടതുകാലത്ത് വേര്‍തിരിച്ചിരിക്കുന്നത് ഈ ടെസ്റ്റിനായി നോട്ടുചെയ്ത ഡാറ്റയുടെ നഷ്ടം വരും',
    ...
    years: "വർഷ",
    deviceDisconnectedRange:
        "ഉപകരണം പ്രത്യാശിച്ചിരിക്കുന്നത് അപ്രത്യാശത്തിലും അംഗീകരിച്ചില്ല. ഉപകരണം അടയാളം പരിധിയിലാണെങ്കിൽ ഉറപ്പാക്കുക.",
    ...
    testCompletedSuccessful:
        "ടെസ്റ്റ് വിജയകരമായി പൂർത്തിയായി. ഇപ്പോൾ നിങ്ങൾ എന്തെങ്കിലും ചെയ്യാൻ തയ്യാറെടുക്കുന്നു?",
    ...
    home: 'ഹോം',
    deviceNotAdded:
        "നിങ്ങൾ ഇതുവരെ ഒരു ഉപകരണം ചേർത്തിട്ടില്ല. തുടരുന്നതിന് ദയവായി ഉപകരണം ചേർക്കുക.",
    chooseImageSource: "ചിത്രം മൂലം തിരഞ്ഞെടുക്കുക",
    cropImage: 'ചിത്രം ക്രോപ്പ് ചെയ്യുക',
    testNext:
        "ടെസ്റ്റ് വിജയകരമായി പൂർത്തിയായിരിക്കുന്നു, നിങ്ങൾ എന്തെങ്കിലും ചെയ്യാനോ?",
    ...
    device: "ഉപകരണം",
    devicePoweredOn:
        "* ദയവായി ഉപകരണം ഓൺ ചെയ്യുക, ധരിക്കുക, കൺനെക്ട് ചെയ്യുകയും തയ്യാറാക്കുക",
    deviceTypeNotSupported: "തിരഞ്ഞെടുത്ത ഉപകരണ തരം നിലവിലുണ്ടാക്കിയിട്ടില്ല",
    deviceNotInTheRange:
        "ഉപകരണം പരിധിയിലായിരിക്കുന്നില്ല. ഉപകരണം ഓൺ ചെയ്യുക, ധരിക്കുക, കൺനെക്ട് ചെയ്യുകയും തയ്യാറാക്കുക",
    ...
    testSuccessSendHRV:
        "ടെസ്റ്റ് വിജയകരമായി hrv സെർവറിലേക്ക് അയയ്ക്കപ്പെട്ടു. നീണ്ടകാലം ശേഷം റിപ്പോർട്ടുകൾ പരിശോധിക്കാം",
    ...
    results: "ഫലങ്ങൾ",
    notAddedDevice:
        "നിങ്ങൾക്ക് ഇതൊന്നും ചേർത്തിട്ടില്ല. തുടരുകയാണെങ്കിൽ ഉപകരണം ചേർക്കുക.",
    ...
    reportsFailed:
        "റിപ്പോർട്ട് നിർമ്മിക്കൽ താളിക്കുന്നു. അപ്പോൾ വീണ്ടും പരീക്ഷിക്കുക",
    deviceKey: "ഉപകരണ കീ",
    ...
    height: "ഉയരം (മീറ്റർ)",
    denyLocation:
        "തുടരാൻ ലൊക്കേഷൻ അനുമതി ആവശ്യമാണ്. ദയവായി അത് പ്രാപ്തമാക്കി വീണ്ടും ശ്രമിക്കുക",
    agree: "അംഗീകരിക്കുക",
    conCent: "അംഗീകരണം",
    confirmRecordShare:
        "സ്ഥിരീകരിക്കുന്നതിലൂടെ, നിങ്ങൾ രേഖപ്പെടുത്തിയ സ്കാൻ ഡാറ്റ പങ്കിടാൻ സമ്മതിക്കുന്നു",
    noInternet: "ഇന്റർനെറ്റ് ഇല്ല",
    checkInternet:
        "ദയവായി നിങ്ങളുടെ ഇന്റർനെറ്റ്\n കണക്ഷൻ പരിശോധിച്ച് വീണ്ടും ശ്രമിക്കുക.",
    reportProcessing:
        'റിപ്പോർട്ട് ഇനിയും പ്രോസസ്സ് ചെയ്യുന്നു. ദയവായി കാത്തിരിക്കുക',
    ...
    success: "വിജയം",
    noInternetRetryFailed:
        " ഇന്റർനെറ്റ് ബന്ധം ഇല്ല! വീണ്ടും ശ്രമിക്കുക പരാജയപ്പെട്ടു",
    retry: "വീണ്ടും",
    forImprovements: "മെച്ചപ്പെടുത്തലുകൾക്കായി",
    reportsNotReady:
        "റിപ്പോർട്ട് ഇതുവരെ തയ്യാറായിട്ടില്ല. ദയവായി കുറച്ചുനേരം കഴിഞ്ഞ് വീണ്ടും പരിശോധിക്കുക",
    reportsFailedGenerate:
        "റിപ്പോർട്ട് സൃഷ്ടിക്കാൻ പരാജയപ്പെട്ടതായി തോന്നുന്നു. ദയവായി വീണ്ടും പരീക്ഷണം നടത്തുക",
    bpmMean: "BPM സാധാരണം",
    ...
    vlfDescription:
        '''രാജകീയതയോടെ പ്രതിരക്ഷാപ്രവർത്തനം തരംതിരിവുകളെക്കുറിച്ചുള്ള അനുഭവം:
    ...
    hfPowerDescription:
        '''റിലാക്സേഷന് അല്ലെങ്കിൽ വ്യക്തിയുടെ പുനരുജ്ജീവന ശക്തി അറിയിച്ചുകൊള്ളുക.
    ...
    sdrr: "SDRR",
    sdrrDescription:
        '''SSDRR എസ്സഡാരാര് ടൊട്ടൽ ഹാർട്ട് റേറ്റ് വേറെ പ്രധാനതയുള്ള വേണ്ടത് (സമയം അടിസ്ഥാനം). ഉയർന്ന മൂല്യങ്ങൾ മൂല്യമില്ല ഹൃദയ ആരോഗ്യത്തിനും ഫിറ്റ്നെസ്. താഴെ മൂല്യങ്ങൾ ശക്തിമൂലമായ സൂചനയാകുന്നു മൂല്യങ്ങൾ വ്യക്തിഗത രാഗ അല്ലെങ്കിൽ മറ്റു പരിസ്ഥിതികൾ.
